...
public interface ICartRepository
{
    ...
    Task UpdateQuantity(string email, int quantity, CancellationToken cancellationToken);
    Task UpdatePrice(string email, decimal price, CancellationToken cancellationToken);
